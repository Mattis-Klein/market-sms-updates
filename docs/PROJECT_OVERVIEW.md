...
- SMS commands for live checks, date checks, ticker lookup, MrBeast subscriber checks, reminders, and feedback.
- Allowlist enforcement and invite request lifecycle, with permanent env allowlist support via MARKET_UPDATES_ALLOWED_NUMBERS.
